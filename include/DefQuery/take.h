...
namespace DefQuery
{
	...
	class take_enumerator : public enumerator<typename TSourceEnumerator::value_type, take_enumerator<TSourceEnumerator>>
	{
	public:
		using TBaseClass = enumerator<typename TSourceEnumerator::value_type, take_enumerator<TSourceEnumerator>>;
	...
	template<typename TSourceEnumerator>
	template <typename TSourceEnumeratorConstr>
	take_enumerator<TSourceEnumerator>::take_enumerator(TSourceEnumeratorConstr&& source, std::size_t itemsToTake)
		: TBaseClass(false)
