...
namespace DefQuery
{
	...
	class reverse_enumerator : public enumerator<typename TSourceEnumerator::value_type, reverse_enumerator<TSourceEnumerator>>
	{
	public:
		using TBaseClass = enumerator<typename TSourceEnumerator::value_type, reverse_enumerator<TSourceEnumerator>>;
	...
	template<typename TSourceEnumerator>
	const typename TSourceEnumerator::value_type& reverse_enumerator<TSourceEnumerator>::operator*() const
	{
