...
{
public:
	class stlrange_iterator
		: public std::iterator<std::forward_iterator_tag, typename TSourceEnumerator::value_type>
	{
	public:
...
template <typename TSourceEnumerator>
typename stlrange_adapter<TSourceEnumerator>::stlrange_iterator
stlrange_adapter<TSourceEnumerator>::begin()
{
	auto hasEnded = false;
...
template <typename TSourceEnumerator>
typename stlrange_adapter<TSourceEnumerator>::stlrange_iterator
stlrange_adapter<TSourceEnumerator>::end()
{
	auto hasEnded = true;
	return stlrange_iterator(*this, hasEnded);
}
...
template <typename TSourceEnumerator>
stlrange_adapter<TSourceEnumerator>::stlrange_iterator::stlrange_iterator(
	stlrange_adapter& stlrange, bool hasEnded)
...
stlrange_adapter<TSourceEnumerator>::stlrange_iterator::operator*() const
{
...
template <typename TSourceEnumerator>
typename stlrange_adapter<TSourceEnumerator>::stlrange_iterator&
stlrange_adapter<TSourceEnumerator>::stlrange_iterator::operator++()
{
...
template <typename TSourceEnumerator>
bool stlrange_adapter<TSourceEnumerator>::stlrange_iterator::operator==(
	const stlrange_iterator& other)
{
