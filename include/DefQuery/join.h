...
class join_enumerator
	: public enumerator<
		  typename std::result_of<TMerging(const typename TLeftEnumerator::value_type&,
										   const typename TRightEnumerator::value_type&)>::type,
		  join_enumerator<TLeftEnumerator,
						  TRightEnumerator,
						  TKeyProjectionLeft,
						  TKeyProjectionRight,
						  TMerging>>
...
public:
	...
	template <typename TLeftEnumeratorConstr,
			  typename TRightEnumeratorConstr,
			  typename TKeyProjectionLeftConstr,
			  typename TKeyProjectionRightConstr,
			  typename TMergingConstr>
	join_enumerator(TLeftEnumeratorConstr&& sourceLeft,
					TRightEnumeratorConstr&& sourceRight,
					TKeyProjectionLeftConstr&& projectionKeyLeft,
					TKeyProjectionRightConstr&& projectionKeyRight,
					TMergingConstr&& merging);
	~join_enumerator();
...
private:
	...
	const TMergedValue& current() const override
	{
		return this->operator*();
	}
...
enumerator<TValue, TDerived>::join(TRightEnumerator&& sourceRight,
								   TKeyProjectionLeft&& keyProjectionLeft,
								   TKeyProjectionRight&& keyProjectionRight,
								   TMerging&& merging) &&
{
	return join_enumerator<TDerived,
						   TRightEnumerator,
						   TKeyProjectionLeft,
						   TKeyProjectionRight,
						   TMerging>(std::move(static_cast<TDerived&>(*this)),
...
join_enumerator<TLeftEnumerator,
				...
				TKeyProjectionLeft,
				TKeyProjectionRight,
				TMerging>::join_enumerator(TLeftEnumeratorConstr&& sourceLeft,
										   TRightEnumeratorConstr&& sourceRight,
										   TKeyProjectionLeftConstr&& projectionKeyLeft,
										   TKeyProjectionRightConstr&& projectionKeyRight,
										   TMergingConstr&& merging)
...
template <typename TLeftEnumerator,
		  ...
		  typename TKeyProjectionRight,
		  typename TMerging>
void join_enumerator<TLeftEnumerator,
					 TRightEnumerator,
					 TKeyProjectionLeft,
					 TKeyProjectionRight,
					 TMerging>::free_current_merged_value()
{
...
template <typename TLeftEnumerator,
		  ...
		  typename TKeyProjectionRight,
		  typename TMerging>
bool join_enumerator<TLeftEnumerator,
					 TRightEnumerator,
					 TKeyProjectionLeft,
					 TKeyProjectionRight,
					 TMerging>::operator++()
{
	while(++_sourceLeft)
	{
		...
		{
			free_current_merged_value();
			new(_currentMergedValue.data())
				TMergedValue(_merging(*_sourceLeft, *_sourceRightCurrent));
...
template <typename TLeftEnumerator,
		  ...
		  typename TKeyProjectionRight,
		  typename TMerging>
const typename join_enumerator<TLeftEnumerator,
							   TRightEnumerator,
							   TKeyProjectionLeft,
							   TKeyProjectionRight,
							   TMerging>::TMergedValue&
join_enumerator<TLeftEnumerator,
				TRightEnumerator,
				TKeyProjectionLeft,
				TKeyProjectionRight,
				TMerging>::operator*() const
{
